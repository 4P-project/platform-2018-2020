    ...
    function _fix() {
        ...
        if ($(window).width() > 992) {
            if (content > height) {
                ...
                $(".boxed_fixed").css("min-height", content + 50 + "px");
            } else {
                //Otherwise, set the sidebar to the height of the window
                $(".left-side, html, body").css("min-height", height - 50 + "px");
                $(".boxed_fixed").css("min-height", height + 50 + "px");
            }
        } else {
            if (content > height) {
                //then set sidebar height to the wrapper
                $(".left-side, html, body").css("min-height", content + 1 + "px");
                $(".boxed_fixed").css("min-height", content + 1 + "px");
            } else {
                //Otherwise, set the sidebar to the height of the window
                $(".left-side, html, body").css("min-height", height + 1 + "px");
                $(".boxed_fixed").css("min-height", height + 1 + "px");
            }
        }
    }
