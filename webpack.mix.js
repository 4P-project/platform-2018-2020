...
let node_packages ='node_modules/';
let resourcesAssets = 'resources/assets/';
let vendors = resourcesAssets + 'vendors/';
let srcCss = resourcesAssets + 'css/';
let srcJs = resourcesAssets + 'js/';
let srcFrontend = resourcesAssets + 'frontend/';

//destination path configuration
let dest = 'public/';
let destFrontend = 'public/frontend/';
...
let paths = {
    ...
    'bootstrap': node_packages + 'bootstrap/dist/',
    ...
    'braintree': node_packages + 'braintree-web-drop-in/dist/browser/'
...
// braintree
mix.copy(paths.braintree + 'dropin.js', destVendors + 'braintree/');
// toastr
...
//sass compilation
mix.standaloneSass(resourcesAssets + 'sass/bootstrap/app.scss', 'public/css/bootstrap.css');
mix.standaloneSass(resourcesAssets + 'sass/buttons/buttons.scss', 'public/css/buttons_sass.css');
mix.standaloneSass(resourcesAssets + 'sass/custom_dark.scss', 'public/css/custom.css');
...
mix.styles(
    [
        ...
        resourcesAssets + 'css/font-awesome.css',
        ...
        paths.pnotify + 'pnotify.css',
        paths.pnotify + 'pnotify.buttons.css'
    ], destCss + 'app.css');

// Main JS file
mix.js(srcJs + 'app.js', destJs + 'main.js');
...
mix.scripts(
    [
        ...
        paths.pnotify + 'pnotify.js',
        paths.pnotify + 'pnotify.animate.js',
        paths.pnotify + 'pnotify.callbacks.js',
        paths.pnotify + 'pnotify.buttons.js'
    ], destJs + 'app.js');


// INDEX PAGE
mix.copy(srcFrontend + 'images', destFrontend + 'images');
mix.copy(srcFrontend + 'fonts', destFrontend + 'fonts');

mix.scripts(
    [
        // vendor
        srcFrontend + 'js/vendor/jquery-1.12.4.min.js',
        srcFrontend + 'js/vendor/bootstrap.min.js',
        srcFrontend + 'js/vendor/modernizr-2.8.3.min.js',

        // plugin
        srcFrontend + 'js/owl.carousel.min.js',
        srcFrontend + 'js/scrollUp.min.js',
        srcFrontend + 'js/magnific-popup.min.js',
        srcFrontend + 'js/contact-form.js',
        srcFrontend + 'js/ajaxchimp.js',
        srcFrontend + 'js/wow.min.js',
        srcFrontend + 'js/plugins.js',
        srcFrontend + 'js/tooltipster.bundle.min.js',
        srcFrontend + 'js/maps.js',
        srcFrontend + 'js/main.js',
        paths.pnotify + 'pnotify.js',
        paths.pnotify + 'pnotify.animate.js',
        paths.pnotify + 'pnotify.callbacks.js',
        paths.pnotify + 'pnotify.buttons.js'
    ], destFrontend + 'js/app.js');

mix.js(srcFrontend + 'js/login.js', destFrontend + 'js/login.js');
//
mix.styles(
    [
        srcFrontend + 'css/bootstrap.min.css',
        srcFrontend + 'css/animate.css',
        srcFrontend + 'css/magnific-popup.css',
        srcFrontend + 'css/main.css',
        srcFrontend + 'css/normalize.css',
        srcFrontend + 'css/overright.css',
        srcFrontend + 'css/owl.carousel.min.css',
        srcFrontend + 'css/responsive.css',
        srcFrontend + 'css/space.css',
        srcFrontend + 'css/theme.css',
        srcFrontend + 'css/themify-icons.css',
        srcFrontend + 'css/style.css',
        srcFrontend + 'css/tooltipster.bundle.min.css',
        srcFrontend + 'css/plugins/tooltipster/sideTip/themes/tooltipster-sideTip-shadow.min.css',
        paths.pnotify + 'pnotify.css',
        paths.pnotify + 'pnotify.buttons.css'
    ], destFrontend + 'css/app.css');
